...
/**
 * GlobalSellingRecommendation complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="GlobalSellingRecommendation"&gt;
 *    &lt;complexContent&gt;
...
public class GlobalSellingRecommendation extends AbstractMwsObject {
     ...
     */
    public GlobalSellingRecommendation withLastUpdated(XMLGregorianCalendar lastUpdated) {
        this.lastUpdated = lastUpdated;
        return this;
    }
     ...
     * @return This instance.
     */
    public GlobalSellingRecommendation withSalesRank(Integer salesRank) {
        this.salesRank = salesRank;
        return this;
    }
     ...
     * @return This instance.
     */
    public GlobalSellingRecommendation withNumberOfOffers(Integer numberOfOffers) {
        this.numberOfOffers = numberOfOffers;
        return this;
    }
     ...
     * @return This instance.
     */
    public GlobalSellingRecommendation withNumberOfOffersFulfilledByAmazon(Integer numberOfOffersFulfilledByAmazon) {
        this.numberOfOffersFulfilledByAmazon = numberOfOffersFulfilledByAmazon;
        return this;
    }
     ...
     * @return This instance.
     */
    public GlobalSellingRecommendation withAverageCustomerReview(BigDecimal averageCustomerReview) {
        this.averageCustomerReview = averageCustomerReview;
        return this;
    }
     ...
     * @return This instance.
     */
    public GlobalSellingRecommendation withNumberOfCustomerReviews(Integer numberOfCustomerReviews) {
        this.numberOfCustomerReviews = numberOfCustomerReviews;
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        numberOfOffersFulfilledByAmazon = r.read("NumberOfOffersFulfilledByAmazon", Integer.class);
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.write("NumberOfOffersFulfilledByAmazon", numberOfOffersFulfilledByAmazon);
    ...
    public void writeTo(MwsWriter w) {
        w.write("https://mws.amazonservices.com/Recommendations/2013-04-01", "GlobalSellingRecommendation",this);
    }
     ...
     * @param numberOfOffersFulfilledByAmazon a {@link java.lang.Integer} object.
     ...
     * @param itemDimensions a {@link com.amazonaws.mws.recommendations.model.ItemDimensions} object.
     * @param recommendationId a {@link java.lang.String} object.
     * @param recommendationReason a {@link java.lang.String} object.
     */
    public GlobalSellingRecommendation(XMLGregorianCalendar lastUpdated, ProductIdentifier itemIdentifier, String itemName, String brandName, String productCategory, Integer salesRank, Price buyboxPrice, Integer numberOfOffers, Integer numberOfOffersFulfilledByAmazon, BigDecimal averageCustomerReview, Integer numberOfCustomerReviews, ItemDimensions itemDimensions, String recommendationId, String recommendationReason) {
        this.lastUpdated = lastUpdated;
        this.itemIdentifier = itemIdentifier;
        this.itemName = itemName;
        this.brandName = brandName;
