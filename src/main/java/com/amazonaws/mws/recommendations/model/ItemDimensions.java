...
public class ItemDimensions extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("https://mws.amazonservices.com/Recommendations/2013-04-01", "ItemDimensions",this);
    }

    /**
     * Value constructor.
     *
     * @param height a {@link com.amazonaws.mws.recommendations.model.DimensionMeasure} object.
     * @param width a {@link com.amazonaws.mws.recommendations.model.DimensionMeasure} object.
     * @param length a {@link com.amazonaws.mws.recommendations.model.DimensionMeasure} object.
     * @param weight a {@link com.amazonaws.mws.recommendations.model.WeightMeasure} object.
     */
    public ItemDimensions(DimensionMeasure height, DimensionMeasure width, DimensionMeasure length, WeightMeasure weight) {
        this.height = height;
        this.width = width;
        this.length = length;
        this.weight = weight;
