...
public class CategoryQuery extends AbstractMwsObject {
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        filterOptions = r.readList("FilterOptions", "FilterOption", String.class);
    }
    ...
    public void writeTo(MwsWriter w) {
        w.write("https://mws.amazonservices.com/Recommendations/2013-04-01", "CategoryQuery",this);
    }
     ...
     * @param filterOptions a {@link java.util.List} object.
     */
    public CategoryQuery(String recommendationCategory,List<String> filterOptions) {
        this.recommendationCategory = recommendationCategory;
        this.filterOptions = filterOptions;
    }    
