 ...
 * </pre>
 */
public class ListRecommendationsByNextTokenRequest extends AbstractMwsObject {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenRequest withMWSAuthToken(String mwsAuthToken) {
        this.mwsAuthToken = mwsAuthToken;
        return this;
    }
    ...
    public void writeTo(MwsWriter w) {
        w.write("https://mws.amazonservices.com/Recommendations/2013-04-01", "ListRecommendationsByNextTokenRequest",this);
    }
     ...
     */
    public ListRecommendationsByNextTokenRequest(String sellerId,String mwsAuthToken,String nextToken) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.nextToken = nextToken;
    }    
     ...
     * @param nextToken a {@link java.lang.String} object.
     */
    public ListRecommendationsByNextTokenRequest(String sellerId,String nextToken) {
        this.sellerId = sellerId;
        this.nextToken = nextToken;
    }
