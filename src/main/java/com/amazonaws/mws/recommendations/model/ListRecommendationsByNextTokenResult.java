...
public class ListRecommendationsByNextTokenResult extends AbstractMwsObject {
     ...
     */
    public void setInventoryRecommendations(List<InventoryRecommendation> inventoryRecommendations) {
     ...
     */
    public ListRecommendationsByNextTokenResult withInventoryRecommendations(InventoryRecommendation... inventoryRecommendations) {
        List<InventoryRecommendation> list = getInventoryRecommendations();
        for (InventoryRecommendation value : inventoryRecommendations) {
            list.add(value);
        }
        return this;
    }
     ...
     *            The new value to set.
     */
    public void setSelectionRecommendations(List<SelectionRecommendation> selectionRecommendations) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withSelectionRecommendations(SelectionRecommendation... selectionRecommendations) {
        List<SelectionRecommendation> list = getSelectionRecommendations();
        for (SelectionRecommendation value : selectionRecommendations) {
            list.add(value);
        }
        return this;
    }
     ...
     *            The new value to set.
     */
    public void setPricingRecommendations(List<PricingRecommendation> pricingRecommendations) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withPricingRecommendations(PricingRecommendation... pricingRecommendations) {
        List<PricingRecommendation> list = getPricingRecommendations();
        for (PricingRecommendation value : pricingRecommendations) {
            list.add(value);
        }
        return this;
    }
     ...
     *            The new value to set.
     */
    public void setFulfillmentRecommendations(List<FulfillmentRecommendation> fulfillmentRecommendations) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withFulfillmentRecommendations(FulfillmentRecommendation... fulfillmentRecommendations) {
        List<FulfillmentRecommendation> list = getFulfillmentRecommendations();
        for (FulfillmentRecommendation value : fulfillmentRecommendations) {
            list.add(value);
        }
        return this;
    }
     ...
     *            The new value to set.
     */
    public void setListingQualityRecommendations(List<ListingQualityRecommendation> listingQualityRecommendations) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withListingQualityRecommendations(ListingQualityRecommendation... listingQualityRecommendations) {
        List<ListingQualityRecommendation> list = getListingQualityRecommendations();
        for (ListingQualityRecommendation value : listingQualityRecommendations) {
            list.add(value);
        }
        return this;
    }
     ...
     *            The new value to set.
     */
    public void setGlobalSellingRecommendations(List<GlobalSellingRecommendation> globalSellingRecommendations) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withGlobalSellingRecommendations(GlobalSellingRecommendation... globalSellingRecommendations) {
        List<GlobalSellingRecommendation> list = getGlobalSellingRecommendations();
        for (GlobalSellingRecommendation value : globalSellingRecommendations) {
            list.add(value);
        }
        return this;
    }
     ...
     *            The new value to set.
     */
    public void setAdvertisingRecommendations(List<AdvertisingRecommendation> advertisingRecommendations) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withAdvertisingRecommendations(AdvertisingRecommendation... advertisingRecommendations) {
        List<AdvertisingRecommendation> list = getAdvertisingRecommendations();
        for (AdvertisingRecommendation value : advertisingRecommendations) {
            list.add(value);
        }
        return this;
    }
    ...
    public void writeTo(MwsWriter w) {
        w.write("https://mws.amazonservices.com/Recommendations/2013-04-01", "ListRecommendationsByNextTokenResult",this);
    }

    /**
     * Value constructor.
     *
     * @param inventoryRecommendations a {@link java.util.List} object.
     * @param selectionRecommendations a {@link java.util.List} object.
     * @param pricingRecommendations a {@link java.util.List} object.
     * @param fulfillmentRecommendations a {@link java.util.List} object.
     * @param listingQualityRecommendations a {@link java.util.List} object.
     * @param globalSellingRecommendations a {@link java.util.List} object.
     * @param advertisingRecommendations a {@link java.util.List} object.
     * @param nextToken a {@link java.lang.String} object.
     */
    public ListRecommendationsByNextTokenResult(List<InventoryRecommendation> inventoryRecommendations, List<SelectionRecommendation> selectionRecommendations, List<PricingRecommendation> pricingRecommendations, List<FulfillmentRecommendation> fulfillmentRecommendations, List<ListingQualityRecommendation> listingQualityRecommendations, List<GlobalSellingRecommendation> globalSellingRecommendations, List<AdvertisingRecommendation> advertisingRecommendations, String nextToken) {
        this.inventoryRecommendations = inventoryRecommendations;
        this.selectionRecommendations = selectionRecommendations;
        this.pricingRecommendations = pricingRecommendations;
        this.fulfillmentRecommendations = fulfillmentRecommendations;
