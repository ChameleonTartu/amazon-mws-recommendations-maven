 ...
 * </pre>
 */
public class AdvertisingRecommendation extends AbstractMwsObject {
     ...
     */
    public AdvertisingRecommendation withLastUpdated(XMLGregorianCalendar lastUpdated) {
        this.lastUpdated = lastUpdated;
        return this;
    }
     ...
     * @return This instance.
     */
    public AdvertisingRecommendation withAvailableQuantity(Integer availableQuantity) {
        this.availableQuantity = availableQuantity;
        return this;
    }
     ...
     * @return This instance.
     */
    public AdvertisingRecommendation withSalesForTheLast30Days(Integer salesForTheLast30Days) {
        this.salesForTheLast30Days = salesForTheLast30Days;
        return this;
    }
    ...
    public void writeTo(MwsWriter w) {
        w.write("https://mws.amazonservices.com/Recommendations/2013-04-01", "AdvertisingRecommendation",this);
    }
     ...
     */
    public AdvertisingRecommendation(XMLGregorianCalendar lastUpdated, ProductIdentifier itemIdentifier, String itemName, String brandName, String productCategory, Integer salesRank, Price yourPricePlusShipping, Price lowestPricePlusShipping, Integer availableQuantity, Integer salesForTheLast30Days, String recommendationId, String recommendationReason) {
        this.lastUpdated = lastUpdated;
        this.itemIdentifier = itemIdentifier;
        this.itemName = itemName;
        this.brandName = brandName;
