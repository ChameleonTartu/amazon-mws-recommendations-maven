...
public class PricingRecommendation extends AbstractMwsObject {
     ...
     */
    public PricingRecommendation withLastUpdated(XMLGregorianCalendar lastUpdated) {
        this.lastUpdated = lastUpdated;
        return this;
    }
     ...
     *            The new value to set.
     */
    public void setLowestMerchantFulfilledOfferPrice(Price lowestMerchantFulfilledOfferPrice) {
     ...
     *            The new value to set.
     */
    public void setLowestAmazonFulfilledOfferPrice(Price lowestAmazonFulfilledOfferPrice) {
     ...
     * @return This instance.
     */
    public PricingRecommendation withNumberOfMerchantFulfilledOffers(Integer numberOfMerchantFulfilledOffers) {
        this.numberOfMerchantFulfilledOffers = numberOfMerchantFulfilledOffers;
        return this;
    }
     ...
     * @return This instance.
     */
    public PricingRecommendation withNumberOfAmazonFulfilledOffers(Integer numberOfAmazonFulfilledOffers) {
        this.numberOfAmazonFulfilledOffers = numberOfAmazonFulfilledOffers;
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        lowestPricePlusShipping = r.read("LowestPricePlusShipping", Price.class);
        priceDifferenceToLowPrice = r.read("PriceDifferenceToLowPrice", Price.class);
        medianPricePlusShipping = r.read("MedianPricePlusShipping", Price.class);
        lowestMerchantFulfilledOfferPrice = r.read("LowestMerchantFulfilledOfferPrice", Price.class);
        lowestAmazonFulfilledOfferPrice = r.read("LowestAmazonFulfilledOfferPrice", Price.class);
        numberOfOffers = r.read("NumberOfOffers", Integer.class);
        numberOfMerchantFulfilledOffers = r.read("NumberOfMerchantFulfilledOffers", Integer.class);
        numberOfAmazonFulfilledOffers = r.read("NumberOfAmazonFulfilledOffers", Integer.class);
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.write("LowestMerchantFulfilledOfferPrice", lowestMerchantFulfilledOfferPrice);
        w.write("LowestAmazonFulfilledOfferPrice", lowestAmazonFulfilledOfferPrice);
        w.write("NumberOfOffers", numberOfOffers);
        w.write("NumberOfMerchantFulfilledOffers", numberOfMerchantFulfilledOffers);
    ...
    public void writeTo(MwsWriter w) {
        w.write("https://mws.amazonservices.com/Recommendations/2013-04-01", "PricingRecommendation",this);
    }

    /**
     * Value constructor.
     *
     * @param lastUpdated a {@link javax.xml.datatype.XMLGregorianCalendar} object.
     * @param itemIdentifier a {@link com.amazonaws.mws.recommendations.model.ProductIdentifier} object.
     * @param itemName a {@link java.lang.String} object.
     * @param condition a {@link java.lang.String} object.
     * @param subCondition a {@link java.lang.String} object.
     * @param fulfillmentChannel a {@link java.lang.String} object.
     * @param yourPricePlusShipping a {@link com.amazonaws.mws.recommendations.model.Price} object.
     * @param lowestPricePlusShipping a {@link com.amazonaws.mws.recommendations.model.Price} object.
     * @param priceDifferenceToLowPrice a {@link com.amazonaws.mws.recommendations.model.Price} object.
     * @param medianPricePlusShipping a {@link com.amazonaws.mws.recommendations.model.Price} object.
     * @param lowestMerchantFulfilledOfferPrice a {@link com.amazonaws.mws.recommendations.model.Price} object.
     * @param lowestAmazonFulfilledOfferPrice a {@link com.amazonaws.mws.recommendations.model.Price} object.
     * @param numberOfOffers a {@link java.lang.Integer} object.
     * @param numberOfMerchantFulfilledOffers a {@link java.lang.Integer} object.
     * @param numberOfAmazonFulfilledOffers a {@link java.lang.Integer} object.
     * @param recommendationId a {@link java.lang.String} object.
     * @param recommendationReason a {@link java.lang.String} object.
     */
    public PricingRecommendation(XMLGregorianCalendar lastUpdated, ProductIdentifier itemIdentifier, String itemName, String condition, String subCondition, String fulfillmentChannel, Price yourPricePlusShipping, Price lowestPricePlusShipping, Price priceDifferenceToLowPrice, Price medianPricePlusShipping, Price lowestMerchantFulfilledOfferPrice, Price lowestAmazonFulfilledOfferPrice, Integer numberOfOffers, Integer numberOfMerchantFulfilledOffers, Integer numberOfAmazonFulfilledOffers, String recommendationId, String recommendationReason) {
        this.lastUpdated = lastUpdated;
        this.itemIdentifier = itemIdentifier;
        this.itemName = itemName;
        this.condition = condition;
