...
public class ListRecommendationsRequest extends AbstractMwsObject {
     ...
     *
     * @return This instance.
     * @param values a {@link com.amazonaws.mws.recommendations.model.CategoryQuery} object.
     */
    public ListRecommendationsRequest withCategoryQueryList(CategoryQuery... values) {
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        categoryQueryList = r.readList("CategoryQueryList", "CategoryQuery", CategoryQuery.class);
    }
    ...
    public void writeTo(MwsWriter w) {
        w.write("https://mws.amazonservices.com/Recommendations/2013-04-01", "ListRecommendationsRequest",this);
    }
     ...
     * @param recommendationCategory a {@link java.lang.String} object.
     * @param categoryQueryList a {@link java.util.List} object.
     */
    public ListRecommendationsRequest(String marketplaceId,String mwsAuthToken,String sellerId,String recommendationCategory,List<CategoryQuery> categoryQueryList) {
        this.marketplaceId = marketplaceId;
        this.mwsAuthToken = mwsAuthToken;
        this.sellerId = sellerId;
        this.recommendationCategory = recommendationCategory;
     ...
     * @param categoryQueryList a {@link java.util.List} object.
     */
    public ListRecommendationsRequest(String marketplaceId,String sellerId,String recommendationCategory,List<CategoryQuery> categoryQueryList) {
        this.marketplaceId = marketplaceId;
        this.sellerId = sellerId;
        this.recommendationCategory = recommendationCategory;
        this.categoryQueryList = categoryQueryList;
