...
public interface MWSRecommendationsSectionService {
     ...
     * @throws MWSRecommendationsSectionServiceException {@link MWSRecommendationsSectionServiceException}
     */
    GetLastUpdatedTimeForRecommendationsResponse getLastUpdatedTimeForRecommendations(
        GetLastUpdatedTimeForRecommendationsRequest request)
     ...
     * @throws MWSRecommendationsSectionServiceException {@link MWSRecommendationsSectionServiceException}
     */
    ListRecommendationsResponse listRecommendations(
        ListRecommendationsRequest request)
        throws MWSRecommendationsSectionServiceException;
     ...
     * @throws MWSRecommendationsSectionServiceException {@link MWSRecommendationsSectionServiceException}
     */
    ListRecommendationsByNextTokenResponse listRecommendationsByNextToken(
        ListRecommendationsByNextTokenRequest request)
        throws MWSRecommendationsSectionServiceException;
