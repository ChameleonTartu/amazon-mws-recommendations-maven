...
public interface MWSRecommendationsSectionServiceAsync extends MWSRecommendationsSectionService {
     ...
     * @return {@code Future<GetLastUpdatedTimeForRecommendationsResponse>} response.
     */
     ...
     * @return {@code Future<ListRecommendationsResponse>} response.
     */
     ...
     * @return {@code Future<ListRecommendationsByNextTokenResponse>} response.
     */
