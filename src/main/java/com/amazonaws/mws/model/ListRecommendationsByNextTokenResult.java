...
public class ListRecommendationsByNextTokenResult extends AbstractMwsObject {
     ...
     */
    public ListRecommendationsByNextTokenResult withInventoryRecommendations(InventoryRecommendation... values) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withSelectionRecommendations(SelectionRecommendation... values) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withPricingRecommendations(PricingRecommendation... values) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withFulfillmentRecommendations(FulfillmentRecommendation... values) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withListingQualityRecommendations(ListingQualityRecommendation... values) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withGlobalSellingRecommendations(GlobalSellingRecommendation... values) {
     ...
     * @return This instance.
     */
    public ListRecommendationsByNextTokenResult withAdvertisingRecommendations(AdvertisingRecommendation... values) {
